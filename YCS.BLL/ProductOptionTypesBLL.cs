...
public class  ProductOptionTypesBLL:Base.ProductOptionTypes
{
...
/// 取实体集合
/// </summary>
public List<ProductOptionTypesModel> GetModels(SqlTransaction trans)
{
StringBuilder SqlQuery = new StringBuilder();
List<SqlParameter> listParams = new List<SqlParameter>();
...
/// 取实体
/// </summary>
public ProductOptionTypesModel GetModel(SqlTransaction trans, string ProductOptionTypeId)
{
StringBuilder SqlQuery = new StringBuilder();
