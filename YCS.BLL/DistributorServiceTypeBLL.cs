...
public class  DistributorServiceTypeBLL:Base.DistributorServiceType
{
...
/// 取实体集合
/// </summary>
public List<DistributorServiceTypeModel> GetModels(SqlTransaction trans)
{
StringBuilder SqlQuery = new StringBuilder();
List<SqlParameter> listParams = new List<SqlParameter>();
...
/// 取实体
/// </summary>
public DistributorServiceTypeModel GetModel(SqlTransaction trans, string DistributorId)
{
StringBuilder SqlQuery = new StringBuilder();
