...
public class  DistributorWebSitePropertySetting
{
...
/// 读取信息
/// </summary>
public DistributorWebSitePropertySettingModel GetInfo(SqlTransaction trans,long SN)
{
...
/// 从缓存读取信息
/// </summary>
public DistributorWebSitePropertySettingModel GetCacheInfo(SqlTransaction trans,long SN)
{
string key="Cache_DistributorWebSitePropertySetting_Model_"+SN;
object value = CacheHelper.GetCache(key);
if (value != null)
return (DistributorWebSitePropertySettingModel)value;
else
{
DistributorWebSitePropertySettingModel disModel = disDAL.GetInfo(trans,SN);
...
/// 插入信息
/// </summary>
public int InsertInfo(SqlTransaction trans,DistributorWebSitePropertySettingModel disModel)
{
...
/// 更新信息
/// </summary>
public int UpdateInfo(SqlTransaction trans,DistributorWebSitePropertySettingModel disModel,long SN)
{
string key="Cache_DistributorWebSitePropertySetting_Model_"+SN;
