...
namespace YCS.BLL.Base
{
    ...
    public class ProductTemplateRelationSetting
    {
        ...
        /// 读取信息
        /// </summary>
        public ProductTemplateRelationSettingModel GetInfo(SqlTransaction trans, long SN)
        {
        ...
        /// 从缓存读取信息
        /// </summary>
        public ProductTemplateRelationSettingModel GetCacheInfo(SqlTransaction trans, long SN)
        {
            string key = "Cache_ProductTemplateRelationSetting_Model_" + SN;
            object value = CacheHelper.GetCache(key);
            if (value != null)
                return (ProductTemplateRelationSettingModel)value;
            else
            {
                ProductTemplateRelationSettingModel proModel = proDAL.GetInfo(trans, SN);
        ...
        /// 插入信息
        /// </summary>
        public int InsertInfo(SqlTransaction trans, ProductTemplateRelationSettingModel proModel)
        {
        ...
        /// 更新信息
        /// </summary>
        public int UpdateInfo(SqlTransaction trans, ProductTemplateRelationSettingModel proModel, long SN)
        {
            string key = "Cache_ProductTemplateRelationSetting_Model_" + SN;
