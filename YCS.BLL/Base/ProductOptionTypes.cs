...
private readonly ProductOptionTypesDAL proDAL=new ProductOptionTypesDAL();
...
/// 读取信息
/// </summary>
public ProductOptionTypesModel GetInfo(SqlTransaction trans,long SN)
{
...
/// 从缓存读取信息
/// </summary>
public ProductOptionTypesModel GetCacheInfo(SqlTransaction trans,long SN)
{
string key="Cache_ProductOptionTypes_Model_"+SN;
object value = CacheHelper.GetCache(key);
if (value != null)
return (ProductOptionTypesModel)value;
else
{
ProductOptionTypesModel proModel = proDAL.GetInfo(trans,SN);
...
/// 插入信息
/// </summary>
public int InsertInfo(SqlTransaction trans,ProductOptionTypesModel proModel)
{
...
/// 更新信息
/// </summary>
public int UpdateInfo(SqlTransaction trans,ProductOptionTypesModel proModel,long SN)
{
string key="Cache_ProductOptionTypes_Model_"+SN;
