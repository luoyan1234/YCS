...
public class  ProductTemplateLibrary
{
...
/// 读取信息
/// </summary>
public ProductTemplateLibraryModel GetInfo(SqlTransaction trans,long SN)
{
...
/// 从缓存读取信息
/// </summary>
public ProductTemplateLibraryModel GetCacheInfo(SqlTransaction trans,long SN)
{
string key="Cache_ProductTemplateLibrary_Model_"+SN;
object value = CacheHelper.GetCache(key);
if (value != null)
return (ProductTemplateLibraryModel)value;
else
{
ProductTemplateLibraryModel proModel = proDAL.GetInfo(trans,SN);
...
/// 插入信息
/// </summary>
public int InsertInfo(SqlTransaction trans,ProductTemplateLibraryModel proModel)
{
...
/// 更新信息
/// </summary>
public int UpdateInfo(SqlTransaction trans,ProductTemplateLibraryModel proModel,long SN)
{
string key="Cache_ProductTemplateLibrary_Model_"+SN;
