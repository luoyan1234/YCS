...
public class  DistributorServiceType
{

private readonly DistributorServiceTypeDAL disDAL=new DistributorServiceTypeDAL();
...
/// 读取信息
/// </summary>
public DistributorServiceTypeModel GetInfo(SqlTransaction trans,long SN)
{
...
/// 从缓存读取信息
/// </summary>
public DistributorServiceTypeModel GetCacheInfo(SqlTransaction trans,long SN)
{
string key="Cache_DistributorServiceType_Model_"+SN;
object value = CacheHelper.GetCache(key);
if (value != null)
return (DistributorServiceTypeModel)value;
else
{
DistributorServiceTypeModel disModel = disDAL.GetInfo(trans,SN);
...
/// 插入信息
/// </summary>
public int InsertInfo(SqlTransaction trans,DistributorServiceTypeModel disModel)
{
...
/// 更新信息
/// </summary>
public int UpdateInfo(SqlTransaction trans,DistributorServiceTypeModel disModel,long SN)
{
string key="Cache_DistributorServiceType_Model_"+SN;
