...
namespace YCS.BLL.Base
{
    ...
    /// -业务逻辑类
    /// 创建人:杨小明
    /// 日期:2017/3/13 10:30:25 +08:00
    /// </summary>

    public class ProductTemplateType
    {
        ...
        /// 读取信息
        /// </summary>
        public ProductTemplateTypeModel GetInfo(SqlTransaction trans, long SN)
        {
        ...
        /// 从缓存读取信息
        /// </summary>
        public ProductTemplateTypeModel GetCacheInfo(SqlTransaction trans, long SN)
        {
            string key = "Cache_ProductTemplateType_Model_" + SN;
            object value = CacheHelper.GetCache(key);
            if (value != null)
                return (ProductTemplateTypeModel)value;
            else
            {
                ProductTemplateTypeModel proModel = proDAL.GetInfo(trans, SN);
        ...
        /// 插入信息
        /// </summary>
        public int InsertInfo(SqlTransaction trans, ProductTemplateTypeModel proModel)
        {
        ...
        /// 更新信息
        /// </summary>
        public int UpdateInfo(SqlTransaction trans, ProductTemplateTypeModel proModel, long SN)
        {
            string key = "Cache_ProductTemplateType_Model_" + SN;
