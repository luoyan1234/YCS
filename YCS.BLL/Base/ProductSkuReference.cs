...
public class  ProductSkuReference
{
...
/// 读取信息
/// </summary>
public ProductSkuReferenceModel GetInfo(SqlTransaction trans,long SN)
{
...
/// 从缓存读取信息
/// </summary>
public ProductSkuReferenceModel GetCacheInfo(SqlTransaction trans,long SN)
{
string key="Cache_ProductSkuReference_Model_"+SN;
object value = CacheHelper.GetCache(key);
if (value != null)
return (ProductSkuReferenceModel)value;
else
{
ProductSkuReferenceModel proModel = proDAL.GetInfo(trans,SN);
...
/// 插入信息
/// </summary>
public int InsertInfo(SqlTransaction trans,ProductSkuReferenceModel proModel)
{
...
/// 更新信息
/// </summary>
public int UpdateInfo(SqlTransaction trans,ProductSkuReferenceModel proModel,long SN)
{
string key="Cache_ProductSkuReference_Model_"+SN;
