...
public class  ProductSpuPropertySetting
{
...
/// 读取信息
/// </summary>
public ProductSpuPropertySettingModel GetInfo(SqlTransaction trans,long SN)
{
...
/// 从缓存读取信息
/// </summary>
public ProductSpuPropertySettingModel GetCacheInfo(SqlTransaction trans,long SN)
{
string key="Cache_ProductSpuPropertySetting_Model_"+SN;
object value = CacheHelper.GetCache(key);
if (value != null)
return (ProductSpuPropertySettingModel)value;
else
{
ProductSpuPropertySettingModel proModel = proDAL.GetInfo(trans,SN);
...
/// 插入信息
/// </summary>
public int InsertInfo(SqlTransaction trans,ProductSpuPropertySettingModel proModel)
{
...
/// 更新信息
/// </summary>
public int UpdateInfo(SqlTransaction trans,ProductSpuPropertySettingModel proModel,long SN)
{
string key="Cache_ProductSpuPropertySetting_Model_"+SN;
