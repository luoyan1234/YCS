...
public class  ProductTemplateVirtualSkuColumn
{
...
/// 读取信息
/// </summary>
public ProductTemplateVirtualSkuColumnModel GetInfo(SqlTransaction trans,long SN)
{
...
/// 从缓存读取信息
/// </summary>
public ProductTemplateVirtualSkuColumnModel GetCacheInfo(SqlTransaction trans,long SN)
{
string key="Cache_ProductTemplateVirtualSkuColumn_Model_"+SN;
object value = CacheHelper.GetCache(key);
if (value != null)
return (ProductTemplateVirtualSkuColumnModel)value;
else
{
ProductTemplateVirtualSkuColumnModel proModel = proDAL.GetInfo(trans,SN);
...
/// 插入信息
/// </summary>
public int InsertInfo(SqlTransaction trans,ProductTemplateVirtualSkuColumnModel proModel)
{
...
/// 更新信息
/// </summary>
public int UpdateInfo(SqlTransaction trans,ProductTemplateVirtualSkuColumnModel proModel,long SN)
{
string key="Cache_ProductTemplateVirtualSkuColumn_Model_"+SN;
