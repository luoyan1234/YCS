...
public class  DistributorServiceSetting
{
...
/// 读取信息
/// </summary>
public DistributorServiceSettingModel GetInfo(SqlTransaction trans,long SN)
{
...
/// 从缓存读取信息
/// </summary>
public DistributorServiceSettingModel GetCacheInfo(SqlTransaction trans,long SN)
{
string key="Cache_DistributorServiceSetting_Model_"+SN;
object value = CacheHelper.GetCache(key);
if (value != null)
return (DistributorServiceSettingModel)value;
else
{
DistributorServiceSettingModel disModel = disDAL.GetInfo(trans,SN);
...
/// 插入信息
/// </summary>
public int InsertInfo(SqlTransaction trans,DistributorServiceSettingModel disModel)
{
...
/// 更新信息
/// </summary>
public int UpdateInfo(SqlTransaction trans,DistributorServiceSettingModel disModel,long SN)
{
string key="Cache_DistributorServiceSetting_Model_"+SN;
