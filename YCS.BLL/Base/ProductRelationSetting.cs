...
public class  ProductRelationSetting
{
...
/// 读取信息
/// </summary>
public ProductRelationSettingModel GetInfo(SqlTransaction trans,long SN)
{
...
/// 从缓存读取信息
/// </summary>
public ProductRelationSettingModel GetCacheInfo(SqlTransaction trans,long SN)
{
string key="Cache_ProductRelationSetting_Model_"+SN;
object value = CacheHelper.GetCache(key);
if (value != null)
return (ProductRelationSettingModel)value;
else
{
ProductRelationSettingModel proModel = proDAL.GetInfo(trans,SN);
...
/// 插入信息
/// </summary>
public int InsertInfo(SqlTransaction trans,ProductRelationSettingModel proModel)
{
...
/// 更新信息
/// </summary>
public int UpdateInfo(SqlTransaction trans,ProductRelationSettingModel proModel,long SN)
{
string key="Cache_ProductRelationSetting_Model_"+SN;
