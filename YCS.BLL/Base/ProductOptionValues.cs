...
/// 读取信息
/// </summary>
public ProductOptionValuesModel GetInfo(SqlTransaction trans,long SN)
{
...
/// 从缓存读取信息
/// </summary>
public ProductOptionValuesModel GetCacheInfo(SqlTransaction trans,long SN)
{
string key="Cache_ProductOptionValues_Model_"+SN;
object value = CacheHelper.GetCache(key);
if (value != null)
return (ProductOptionValuesModel)value;
else
{
ProductOptionValuesModel proModel = proDAL.GetInfo(trans,SN);
...
/// 插入信息
/// </summary>
public int InsertInfo(SqlTransaction trans,ProductOptionValuesModel proModel)
{
...
/// 更新信息
/// </summary>
public int UpdateInfo(SqlTransaction trans,ProductOptionValuesModel proModel,long SN)
{
string key="Cache_ProductOptionValues_Model_"+SN;
