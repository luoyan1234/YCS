...
public class  DistributorProfileBLL:Base.DistributorProfile
{
...
/// 取实体集合
/// </summary>
public List<DistributorProfileModel> GetModels(SqlTransaction trans)
{
StringBuilder SqlQuery = new StringBuilder();
List<SqlParameter> listParams = new List<SqlParameter>();
...
/// 取实体
/// </summary>
public DistributorProfileModel GetModel(SqlTransaction trans, string DistributorId)
{
StringBuilder SqlQuery = new StringBuilder();
