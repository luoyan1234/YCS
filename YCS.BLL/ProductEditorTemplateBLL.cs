...
public class  ProductEditorTemplateBLL:Base.ProductEditorTemplate
{
...
/// 取实体集合
/// </summary>
public List<ProductEditorTemplateModel> GetModels(SqlTransaction trans)
{
StringBuilder SqlQuery = new StringBuilder();
List<SqlParameter> listParams = new List<SqlParameter>();
...
/// 取实体
/// </summary>
public ProductEditorTemplateModel GetModel(SqlTransaction trans, long SN)
{
StringBuilder SqlQuery = new StringBuilder();
