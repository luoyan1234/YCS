...
/// -业务逻辑类
/// 创建人:杨小明
/// 日期:2017/3/13 10:18:04 +08:00
/// </summary>

public class  ProductTemplateBLL:Base.ProductTemplate
{

private readonly ProductTemplateDAL proDAL=new ProductTemplateDAL();
...
/// 取实体集合
/// </summary>
public List<ProductTemplateModel> GetModels(SqlTransaction trans)
{
StringBuilder SqlQuery = new StringBuilder();
List<SqlParameter> listParams = new List<SqlParameter>();
...
/// 取实体
/// </summary>
public ProductTemplateModel GetModel(SqlTransaction trans, long SN)
{
StringBuilder SqlQuery = new StringBuilder();
